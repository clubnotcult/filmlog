...
/** Green only for the fully-synced, confirmed-good state — matches the color system's "confirmed/success" meaning. Partial and unsynced stay neutral, not warnings. */
export function syncStatusColorClass(status: SyncStatus): string {
  return status === "synced" ? "text-fd-green" : "text-muted";
}
