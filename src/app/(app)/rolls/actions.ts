...
export async function createRoll(
  ...
  // A single RPC call: decrements film stock inventory and inserts the roll
  // as one atomic transaction (see supabase/migrations for create_roll). If
  // either step fails — including "no inventory left" — nothing is written.
