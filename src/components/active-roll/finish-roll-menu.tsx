  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex h-9 w-9 items-center justify-center rounded-md border border-border text-muted-strong hover:text-foreground"
      >
        ⋯
      </button>

      {step !== "closed" && (
        <div className="absolute right-0 top-11 z-20 w-72 rounded-md border border-border bg-surface-raised p-4 shadow-lg">
          {step === "menu" && (
            <button
              type="button"
              onClick={() => setStep("confirm1")}
              className="w-full rounded-md border border-border px-3 py-2 text-left text-sm text-foreground hover:border-red-400 hover:text-red-400"
            >
              Finish Roll
            </button>
          )}
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-end gap-2">
                ...
                <button
                  ...
                  className="rounded-md bg-red-400 px-3 py-1.5 text-xs font-medium text-black disabled:opacity-50"
                >
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col gap-2">
                ...
                <button
                  ...
                  className="rounded-md border border-red-400/50 px-3 py-2 text-xs text-red-400 hover:bg-red-400/10 disabled:opacity-50"
                >
